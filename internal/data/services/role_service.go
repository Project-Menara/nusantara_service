...
type RoleService interface {
	...
	GetAllRole(ctx context.Context, page, limit int) ([]*entities.RoleEntity, int, error)
	GetByIdRole(ctx context.Context, id uuid.UUID) (*entities.RoleEntity, error)
	UpdateRole(ctx context.Context, id uuid.UUID, req dto.UpdateRoleRequest) (*entities.RoleEntity, error)
